...
the codebase. **Layout: single-context.**
...
There is no `CONTEXT-MAP.md` — this is a single-context repo. All ADRs live at
`docs/adr/`; there are no per-context `src/<context>/docs/adr/` directories.

## Use the glossary's vocabulary

When your output names a domain concept (in a task title, a refactor proposal, a
