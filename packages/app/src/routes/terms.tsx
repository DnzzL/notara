	...
	return (
		<div className="legal-page">
			...
			<article className="legal-content">
				...
				<p>
					These terms govern your use of the Notara marketing site and any
					hosted services operated by Thomas Legrand (sole developer, "we").
					Your separate license to the Notara software is covered by the{" "}
					<a
						href="https://github.com/dnzzl/notara/blob/main/LICENSE"
						target="_blank"
						rel="noopener noreferrer"
					>
						LICENSE
					</a>{" "}
					file in the source repository, not by this document.
				</p>
				...
				<p>
					...
					that happens under your account. You must be at least 16 years old.
				</p>
				...
				<ul>
					...
					<li>
						Reverse-engineer the software except as allowed by the license.
					</li>
				</ul>
				...
				<p>
					We may push updates to the public source repository at any time; they
					are available to everyone under the licence. We may change the product
					in ways that require migration; we will document those migrations in
					the release notes.
				</p>

				<h2>6. Service availability</h2>
				<p>
					The marketing site and (future) hosted cloud version are provided "as
					is" without any uptime guarantee. We aim for best-effort availability
					and will be transparent when things break.
				</p>

				<h2>7. Limitation of liability</h2>
				<p>
					To the maximum extent permitted by law, our aggregate liability
					arising from or related to your use of Notara is limited to the amount
				...
				<p>
					...
					accounts that breach these terms, after notice where reasonable.
					License rights to the source code you have already received continue
					under the terms of the LICENSE file even if your account is closed.
				</p>

				<h2>9. Governing law</h2>
				<p>
					These terms are governed by the laws of France. Any dispute that
					cannot be resolved amicably falls under the exclusive jurisdiction of
