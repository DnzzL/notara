...
export function ConsentBanner() {
	const [decision, setDecisionState] = useState<ConsentDecision | null>(() =>
		getConsent(),
	);
		...
		>
			<div className="consent-banner-inner">
				<div id="consent-banner-body" className="consent-banner-text">
					<strong>Cookies, briefly:</strong> we use a single privacy-friendly
					analytics tool (PostHog, hosted in the EU) to learn what works on this
					page. Everything you do here stays optional. Read the details in our{" "}
