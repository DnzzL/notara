		...
		<div className="landing">
			...
			<header className="landing-hero">
				<div className="lp-wrap">
					<div
						className="lp-hero-tag lp-reveal"
					...
					<h1
						className="landing-headline lp-reveal"
						style={{ animationDelay: ".12s" }}
					>
						The notes app
						<br />
						you <span className="out">actually</span>{" "}
						<span className="blue">own.</span>
					</h1>
					<div className="lp-hero-lower">
						<div className="lp-hero-text">
							<p className="lp-reveal" style={{ animationDelay: ".24s" }}>
								...
								inline databases, real-time collaboration — all backed by a
								single SQLite file on your own server. Free to self-host. Keep
								the source. Walk away whenever you like.
							</p>
							<div
								className="landing-hero-ctas lp-reveal"
			...
			<section className="lp-specs">
				<div className="lp-wrap lp-specs-in">
					<div className="lp-spec">
						<div className="num">
							1<span className="u">×</span>
						</div>
						<div className="lbl">SQLite file · your data</div>
					</div>
					<div className="lp-spec">
						<div className="num">
							0<span className="u">/mo</span>
						</div>
						<div className="lbl">Subscriptions, forever</div>
					</div>
					<div className="lp-spec">
						<div className="num">∞</div>
						<div className="lbl">Workspaces &amp; members</div>
					</div>
					<div className="lp-spec">
						<div className="num">
			...
			<section className="lp-object">
				<div className="lp-wrap lp-object-in">
					<div className="lp-object-txt">
						...
						<p>
							Everything you write lives in a single SQLite file on a server you
							control. The source is public — read it, modify it, export your
							data, walk away. There is nothing to be locked into.
						</p>
					</div>
					<div className="lp-object-file">
						<div className="lp-file-top">
							<i />
							<i />
							<i />
							<span className="p">~/notara.sqlite</span>
						</div>
						<div className="lp-file-body">
							<div className="lp-frow title">
								<span className="n">01</span>
								<span>Getting started</span>
							</div>
							<div className="lp-frow">
								<span className="n">02</span>
								<span>Everything lives in one SQLite file.</span>
							</div>
							<div className="lp-frow">
								<span className="n">03</span>
								<span className="lp-chk on" />
								<span className="lp-done">Import your Notion export</span>
							</div>
							<div className="lp-frow">
						...
						<div className="lp-file-foot">
							<span>1 file · 0 vendors</span>
							<span>yours, on disk</span>
						</div>
					</div>
				</div>
			</section>
			...
			<div className="lp-strip">
				<div className="lp-strip-in">
					<span>
						FAIR-SOURCE<em>/</em>FREE TO SELF-HOST<em>/</em>SELF-HOSTED
						<em>/</em>NO SUBSCRIPTION<em>/</em>NO CLOUD LOCK-IN<em>/</em>OPEN
						REST API<em>/</em>CLI INCLUDED<em>/</em>
					</span>
					...
					{features.map((f, i) => (
						<div key={f.title} className="lp-feat-row">
							...
							<p>
								{f.code ? (
									<>
										Drive Notara from your terminal with the scriptable{" "}
										<code>{f.code}</code> CLI — pipe JSON straight into your
										tools.
									</>
								) : (
									f.desc
			...
			<section className="landing-dev">
				<div className="lp-wrap landing-dev-in">
					<span className="lp-kicker">
						<b>02</b> · For developers & AI agents
					</span>
					<h2>
						Automate everything.
						<br />
						Your tools &mdash; your way.
					</h2>
					<div className="lp-dev-examples">
						<div className="lp-dev-ex">
							<div className="lp-dev-cmd">
								notara pages list --json | jq '.title'
							</div>
							<div className="lp-dev-desc">
								Pipe your entire wiki into any script or AI agent
							</div>
						</div>
						<div className="lp-dev-ex">
							<div className="lp-dev-cmd">
								curl -X POST $HOST/api/pages \<br />
								&nbsp;&nbsp;-H "X-Api-Key: $KEY" -d '{"{"}
								&quot;title&quot;:&quot;...&quot;{"}"}
							</div>
							<div className="lp-dev-desc">
								Create pages from CI/CD, bots, or agent workflows
							</div>
						</div>
						<div className="lp-dev-ex">
							<div className="lp-dev-cmd">
								<span className="lp-dev-openapi">openapi.yaml</span> &middot;
								30+ endpoints
							</div>
							<div className="lp-dev-desc">
								Full REST API &mdash; read, write, search, manage. API-key auth.
							</div>
						</div>
						<div className="lp-dev-ex">
							<div className="lp-dev-cmd">
								<a
									href="https://jsr.io/@notara/cli"
									target="_blank"
									rel="noopener noreferrer"
									className="lp-dev-jsr"
								>
									@notara/cli
								</a>{" "}
								on JSR
							...
							<div className="lp-dev-desc">
								Install via <code>npx jsr add @notara/cli</code> &mdash; pipe
								JSON, automate, script.
							</div>
						</div>
					</div>
					<a href="/api/docs" className="landing-dev-link">
						Browse the API docs →
					</a>
				</div>
			</section>
				...
				<div className="lp-wrap">
					...
					<div className="lp-sheet">
						<div className="lp-sheet-left">
							...
							<h3>What you get</h3>
							{planFeatures.map((f) => (
								<div key={f} className="lp-sline">
									{f}
									<span className="c">INCL</span>
								</div>
							))}
						</div>
