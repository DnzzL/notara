import { Toast, Toaster as ArkToaster, type ToastOptions } from "@ark-ui/react/toast";
...
function CheckIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" aria-hidden="true">
      ...
      <path d="M5.5 9.5l2.5 2.5 4.5-4.5" stroke="var(--success)" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
function ErrorIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" aria-hidden="true">
      ...
      <path d="M6 6l6 6M12 6l-6 6" stroke="var(--danger)" strokeWidth="1.7" strokeLinecap="round" />
    </svg>
  );
}
...
function WarningIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" aria-hidden="true">
      ...
      <path d="M9 6v4" stroke="var(--warning)" strokeWidth="1.7" strokeLinecap="round" />
...
function InfoIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" aria-hidden="true">
      ...
      <path d="M9 8v4" stroke="var(--accent)" strokeWidth="1.7" strokeLinecap="round" />
  ...
  return (
    <Portal>
      <ArkToaster toaster={toaster} className="toast-group">
        {(toast: ToastOptions) => (
          <Toast.Root key={toast.id} className={`toast toast--${toast.type ?? "info"}`}>
