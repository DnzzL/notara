import {
  operatorsForFieldType, OPERATOR_LABELS,
  type Filter, type Sort, type FilterOperator,
      ...
      {filters.map((filter, idx) => {
        ...
        return (
          <div key={idx} className="flex gap-1 items-center bg-surface-2 rounded py-1 px-2 border border-border">
            ...
            {showValue && (
              <FilterValueInput field={field} value={filter.value} onChange={(v) => onChange(idx, { value: v })} />
            )}
