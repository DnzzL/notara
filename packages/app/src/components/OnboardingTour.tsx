import { Tour, type TourStepDetails, useTour } from "@ark-ui/react";
...
const steps: TourStepDetails[] = [
	...
	},
	{
		...
		description:
			"Drag to reorder, nest pages inside pages, favorite the ones you live in.",
		actions: NEXT_PREV,
	},
	{
		id: "search",
		...
		description:
			"Search every page and block content from anywhere — no mouse needed.",
		actions: NEXT_PREV,
	},
	{
		id: "new-page",
		...
		description:
			"Start blank, or pick a template — meeting notes, project plan, weekly review.",
		actions: NEXT_PREV,
	},
	{
		id: "editor",
		...
		description:
			"Headings, to-dos, code, images, inline databases — all from the slash menu.",
		actions: [
			{ label: "Back", action: "prev" },
	...
	},
	{
		...
		title: "You're set 🎉",
		description:
			"Open the Getting Started page in your sidebar for next steps. Retake this tour anytime from the Help menu in the sidebar.",
