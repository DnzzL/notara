		...
		>
			...
			>
				...
				<div className="flex flex-col gap-px min-w-0">
					...
					<span className="text-[12px] text-text-3 whitespace-nowrap overflow-hidden text-ellipsis">
						Start from scratch
					</span>
				</div>
			</button>
			...
			{templates.length > 0 && (
				<>
					<div className="text-[11px] font-semibold uppercase tracking-[0.07em] text-text-3 pt-2.5 pb-1">
