...
export class DatabaseRecord extends Schema.Class<DatabaseRecord>(
	"DatabaseRecord",
)({
	id: Schema.String,
	databaseId: Schema.String,
...
export class RecordFieldValue extends Schema.Class<RecordFieldValue>(
	"RecordFieldValue",
)({
	id: Schema.String,
...
export class DatabaseCsvExport extends Schema.Class<DatabaseCsvExport>(
	"DatabaseCsvExport",
)({
	dbId: Schema.String,
	name: Schema.String,
...
export class ExportAllResult extends Schema.Class<ExportAllResult>(
	"ExportAllResult",
)({
...
export class TrashedDatabase extends Schema.Class<TrashedDatabase>(
	"TrashedDatabase",
)({
	id: Schema.String,
	name: Schema.String,
...
export class PagePermissions extends Schema.Class<PagePermissions>(
	"PagePermissions",
)({
