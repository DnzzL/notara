...
- Name: database-views.spec.ts >> Database Views >> CR-3: '+' on a day creates a record dialog
- Location: e2e/database-views.spec.ts:153:6
      ...
      - complementary [ref=e4]:
        ...
        - navigation [ref=e17]:
          - tree "Tree View" [ref=e19]:
            - treeitem "⋮⋮ 📄 Calendar Test ms7ixlrg ⋯" [expanded] [level=1] [selected] [ref=e21]:
              - button "⋮⋮ 📄 Calendar Test ms7ixlrg ⋯" [ref=e22] [cursor=pointer]:
                - button "⋮⋮" [ref=e23]
                - generic [ref=e24]: ▶
                - generic "Change icon" [ref=e25]: 📄
                - generic [ref=e26]: Calendar Test ms7ixlrg
                - button "⋯" [ref=e27]
            ...
            - treeitem "⋮⋮ 📄 Calendar Test ms7iwye9 ⋯" [expanded] [level=1] [ref=e157]:
              - button "⋮⋮ 📄 Calendar Test ms7iwye9 ⋯" [ref=e158] [cursor=pointer]:
                ...
                - button "⋯" [ref=e163]
        - generic [ref=e164]:
          - button "+ New page" [ref=e165] [cursor=pointer]:
            - generic [ref=e166]: +
            - text: New page
          - button "? Help" [ref=e167] [cursor=pointer]:
            - generic [ref=e168]: "?"
            - text: Help
        - generic "Resize sidebar" [ref=e169]
      - status [ref=e170]
      - generic [ref=e171]:
        - generic [ref=e172]:
          - generic [ref=e173]:
            - button "📄" [ref=e174] [cursor=pointer]
            - heading "Calendar Test ms7ixlrg" [level=1] [ref=e175] [cursor=pointer]
              ...
              - generic:
                ...
                - button "Click for options, drag to reorder":
                  - generic "Drag to reorder":
                    - img
              - textbox [ref=e186]:
                - paragraph [ref=e187]: Type '/' for commands
            - button "+ New block" [ref=e188] [cursor=pointer]:
              - generic [ref=e189]: +
              - generic [ref=e190]: New block
            - generic [ref=e192]:
              - generic [ref=e193]:
                - button "+" [ref=e194] [cursor=pointer]
                - button "Click for options, drag to reorder" [ref=e195]:
                  - generic "Drag to reorder" [ref=e196]:
                    - img [ref=e197]
              - generic [ref=e204]:
                - generic [ref=e205]:
                  - generic [ref=e206]:
                    - button "Grid" [ref=e208] [cursor=pointer]:
                      - img [ref=e209]
                      - generic [ref=e214]: Grid
                      - img [ref=e215]
                    - tablist [ref=e217]:
                      - tab "Table" [selected] [ref=e218] [cursor=pointer]
                      - tab "Board" [ref=e219] [cursor=pointer]
                      - tab "Calendar" [ref=e220] [cursor=pointer]
                    - generic [ref=e221]:
                      - button "Filter" [ref=e222] [cursor=pointer]:
                        - img [ref=e223]
                        - text: Filter
                      - button "Sort" [ref=e225] [cursor=pointer]:
                        - img [ref=e226]
                        - text: Sort
                    - generic [ref=e229] [cursor=pointer]: Untitled
                  - table [ref=e231]:
                    - rowgroup [ref=e232]:
                      - row "🌐 Name ⋮⋮ Aa Notes ▼ +" [ref=e233]:
                        - columnheader [ref=e234]
                        - columnheader "🌐 Name" [ref=e235]:
                          - generic [ref=e236] [cursor=pointer]:
                            - generic [ref=e237]: 🌐
                            - generic [ref=e238]: Name
                        - columnheader "⋮⋮ Aa Notes ▼" [ref=e240]:
                          - button "⋮⋮" [ref=e241]
                          - generic [ref=e242] [cursor=pointer]:
                            - generic [ref=e243]: Aa
                            - generic [ref=e244]: Notes
                            - generic [ref=e245]: ▼
                        - columnheader "+" [ref=e247]:
                          - button "+" [ref=e248] [cursor=pointer]
                    - rowgroup [ref=e249]:
                      - row "Select row (Shift+click for range) ⋮⋮ ↗ × Untitled" [ref=e250]:
                        - cell "Select row (Shift+click for range) ⋮⋮ ↗ ×" [ref=e251]:
                          - checkbox "Select row (Shift+click for range)" [ref=e252] [cursor=pointer]
                          - button "⋮⋮" [ref=e253]
                          - button "↗" [ref=e254] [cursor=pointer]
                          - button "×" [ref=e255] [cursor=pointer]
                        - cell "Untitled" [ref=e256]:
                          - generic [ref=e257]: Untitled
                        - cell [ref=e258]
                        - cell [ref=e260]
                      - row "+ New record" [ref=e261]:
                        - cell "+ New record" [ref=e262]:
                          - button "+ New record" [active] [ref=e263] [cursor=pointer]
                    - rowgroup [ref=e264]:
                      - row "Calculate Calculate Calculate Calculate" [ref=e265]:
                        - cell [ref=e266]
                        - cell "Calculate Calculate" [ref=e267]:
                          - generic [ref=e268]:
                            - generic [ref=e269]: Calculate
                            - combobox "Summary" [ref=e270] [cursor=pointer]:
                              - option "Calculate" [selected]
                              - option "Count all"
                              - option "Count values"
                              - option "Count empty"
                        - cell "Calculate Calculate" [ref=e271]:
                          - generic [ref=e272]:
                            - generic [ref=e273]: Calculate
                            - combobox "Summary" [ref=e274] [cursor=pointer]:
                              - option "Calculate" [selected]
                              - option "Count all"
                              - option "Count values"
                              - option "Count empty"
                        - cell [ref=e275]
                  - dialog "Record details" [ref=e277]:
                    - banner [ref=e278]:
                      - button "Close" [ref=e279] [cursor=pointer]: ×
                    - textbox "Untitled" [ref=e280]
                    - button "↗ Open as page" [ref=e281] [cursor=pointer]
                    - generic [ref=e284]: Notes
                - status [ref=e287]
          - button "▶ 0 backlinks" [ref=e289] [cursor=pointer]:
            - generic [ref=e290]: ▶
            - generic [ref=e291]: 0 backlinks
        - status [ref=e292]
    - generic:
      - contentinfo:
        - button "Open TanStack Router Devtools" [ref=e293] [cursor=pointer]:
          - generic [ref=e294]:
            - img [ref=e296]
            - img [ref=e331]
          - generic [ref=e365]: "-"
          - generic [ref=e366]: TanStack Router
