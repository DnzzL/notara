...
- Name: basic.spec.ts >> Basic User Stories >> use slash command to create database
- Location: e2e/basic.spec.ts:46:7
...
- generic [ref=e3]:
  - complementary [ref=e4]:
    - generic [ref=e5]:
      - textbox "Search pages..." [ref=e6]
      - textbox "Page title..." [active] [ref=e7]: Database Test
    - navigation [ref=e8]:
      - generic [ref=e9]: No pages yet
  - generic [ref=e11]:
    - heading "Welcome" [level=2] [ref=e12]
    - paragraph [ref=e13]: Select a page from the sidebar or create a new one
```
