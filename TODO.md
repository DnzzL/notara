...
- [ ] Enter splits current block
- [ ] Delete empty block when backspace on empty

### 3. Drag & Drop Blocks
- [ ] Drag handle on blocks
- [ ] Reorder blocks within page
- [ ] Drop indicator between blocks
- [ ] Drag to sidebar to move to another page
...
- [ ] Full-text search in page titles
- [ ] Full-text search in block content (use FTS)
