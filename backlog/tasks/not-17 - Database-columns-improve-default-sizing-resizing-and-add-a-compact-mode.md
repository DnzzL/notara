...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 Set sensible default column widths based on field type (e.g., text/select ~120px, number ~90px, date ~130px)
- [x] #2 Ensure db-col-resize-handle works reliably and persists column widths per-user per-database
- [x] #3 Add a compact mode toggle that reduces padding, font sizes, and min-widths in the table
- [x] #4 Add a 'Hide column' option to the column header menu
<!-- AC:END -->
